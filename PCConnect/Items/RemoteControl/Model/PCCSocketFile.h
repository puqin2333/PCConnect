...
@protocol PCCSocketFileDelegate <NSObject>
...
@interface PCCSocketFile : NSObject<AsyncSocketDelegate>
...
@property(nonatomic, strong) id<PCCSocketFileDelegate> fileDelegate;

+ (instancetype)shareInstance;
- (void)socketConnectHost; // socket连接
- (void)sendFile:(NSString *)fileString; // 文件命令
